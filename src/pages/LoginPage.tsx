...
import { AiBrain01FreeIcons, Call02Icon, Shield01Icon, SquareLock01Icon, UserCheck01Icon, ViewOffIcon } from "@hugeicons/core-free-icons";
...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-[#0C0C0C] font-sans">
      {/* ── Left Banner Panel ── */}
      <div className="w-[40%] hidden lg:flex flex-col justify-between bg-[#F5F5F5] dark:bg-[#151515] p-12">
        {/* Top Logo */}
        <div className="flex items-center gap-3">
          <img src="/Mark.svg" alt="Mark" className="h-9.5 w-9.5 object-contain" />
          <span className="text-[20px] text-[#737373] dark:text-[#A3A3A3]">
        ...
        <div className="max-w-[420px] my-auto space-y-8">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-4">
              <div className="w-8.5 h-8.5 rounded-md bg-white dark:bg-[] text-[#0474F3] flex items-center justify-center shrink-0">
                <HugeIcon icon={Shield01Icon} size={17} strokeWidth={3} />
              </div>
              <div>
                <h4 className="text-[12px] font-semibold text-[#0A0A0A] dark:text-white">Maxfiy tizim</h4>
            ...
            <div className="flex items-start gap-4">
              <div className="w-8.5 h-8.5 rounded-md bg-white dark:bg-[] text-[#0474F3] flex items-center justify-center shrink-0">
                <HugeIcon icon={UserCheck01Icon} size={17} strokeWidth={3} />
              </div>
              <div>
                <h4 className="text-[12px] font-semibold text-[#0A0A0A] dark:text-white">Profil moderatsiyasi</h4>
            ...
            <div className="flex items-start gap-4">
              <div className="w-8.5 h-8.5 rounded-md bg-white dark:bg-[] text-[#0474F3] flex items-center justify-center shrink-0 ">
                <HugeIcon icon={AiBrain01FreeIcons} size={17} strokeWidth={3} />
              </div>
              <div>
                <h4 className="text-[12px] font-semibold text-[#0A0A0A] dark:text-white">AI nazorati</h4>
        ...
        {/* Bottom copyright */}
        <div className="text-[11px] text-[#6B6B6B] dark:text-[#525252]">
      ...
      <div className="w-full lg:w-[60%] flex flex-col justify-center items-center p-6 bg-white dark:bg-[#0C0C0C]">
        <form onSubmit={handleLogin} className="w-full max-w-[380px] space-y-6">
          {/* Header */}
          <div>
            <h1 className="text-[20px] font-semibold text-[#0A0A0A] dark:text-white tracking-tight">Tizimga kirish</h1>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••"
                  className={`w-full h-11 pl-10 pr-10 bg-transparent border ${error ? "border-[#DC2626]" : "border-[#E5E5E5] dark:border-[#262626]"
                ...
                <button
                  ...
                  className="absolute cursor-pointer right-3.5 top-1/2 -translate-y-1/2 text-[#737373] dark:text-[#A3A3A3] hover:text-[#0A0A0A] dark:hover:text-white transition-colors"
                >
                  {showPassword ? (
                    <EyeOff className="w-4 h-4" strokeWidth={2.2} />
                  ) : (
                    <HugeIcon icon={ViewOffIcon} className="w-4 h-4" strokeWidth={2.2} />
                  )}
                </button>
              </div>
            </div>
          ...
          {/* Error Message Box */}
          {error && (
            <div className="flex items-start gap-3 p-3 bg-[#FEF2F2] dark:bg-[#2C1A1A] border border-[#FCA5A5] dark:border-[#5C2A2A] rounded-md text-[#7F1D1D] dark:text-[#E57373] transition-all">
          ...
          <div className="flex items-center gap-2.5 px-3.5 h-9.5 bg-[#F5F5F5] dark:bg-[#151515] rounded-lg text-[#525252] dark:text-[#A3A3A3]">
            <HugeIcon icon={Shield01Icon} className="w-4 h-4 text-[#737373] dark:text-[#A3A3A3]" strokeWidth={2.3} />
            <span className="text-[11px]">Maxfiy tizim. Barcha kirishlar qayd etiladi.</span>
          </div>
        </form>
      </div>
    </div>
